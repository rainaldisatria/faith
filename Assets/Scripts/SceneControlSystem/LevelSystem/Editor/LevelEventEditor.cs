...
[CustomEditor(typeof(LevelEvent), true)]
public class LevelEventEditor : Editor
{
    private Type _levelEvent = typeof(LevelEvent);
    ...
    private static readonly string[] ExcludedProperties = { "m_Script", nameof(LevelEvent.SceneName) };
    ...
    {
        _selectedLevelEvent = (LevelEvent)target;
        PrepareSceneList(); 
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.ObjectField("Script", MonoScript.FromScriptableObject((LevelEvent)target), typeof(LevelEvent), false);
        // Make GUI changeable
        GUI.enabled = true;
